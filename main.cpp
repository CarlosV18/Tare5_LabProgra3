...
//                }
                ...
                if(Event.key.keysym.sym == SDLK_RETURN)
                {
                    ...
                    {
                        case 1:
                            sho_punching_rect.x = 800;
                            sho_punching_rect.y = 250;
                            SDL_RenderCopy(renderer, sho_punching_menu, NULL, &sho_punching_rect);
                           SDL_RenderPresent(renderer);
                            loopJuego();
                        break;
                        case 2:
                            sho_punching_rect.x = 800;
                            sho_punching_rect.y = 350;
                            SDL_RenderCopy(renderer, sho_punching_menu, NULL, &sho_punching_rect);
                            SDL_RenderPresent(renderer);
                            instructions();
        ...
        if(((Event.key.keysym.sym == SDLK_RETURN)==false) && opcion==1 || opcion==2|| opcion==3 ){
            if(opcion==1){
                sho_standing_rect.x = 800;
                sho_standing_rect.y = 250;
                SDL_RenderCopy(renderer, sho_standing_menu, NULL, &sho_standing_rect);
            }
            if(opcion==2){
                sho_standing_rect.x = 800;
                sho_standing_rect.y = 350;
                SDL_RenderCopy(renderer, sho_standing_menu, NULL, &sho_standing_rect);
            }
            if(opcion==3){
                sho_standing_rect.x = 800;
                sho_standing_rect.y = 450;
                SDL_RenderCopy(renderer, sho_standing_menu, NULL, &sho_standing_rect);
            }
